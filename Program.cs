...
using BaseApiNet6.Modules.User.Application.Adapter;
using BaseApiNet6.Modules.User.Application.Port;
using BaseApiNet6.Modules.User.Domain.IRepository;
using BaseApiNet6.Modules.User.Infraestructure.Presenter;
using BaseApiNet6.Modules.User.Infraestructure.Repository;
